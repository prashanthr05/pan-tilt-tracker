...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/yeshi/catkin_ws/src/control)
  set(control_DEVEL_PREFIX /home/yeshi/catkin_ws/src/control/devel)
...
if(NOT "/home/yeshi/catkin_ws/src/control/include" STREQUAL "")
  set(control_INCLUDE_DIRS "")
  set(_include_dirs "/home/yeshi/catkin_ws/src/control/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'aura <aura@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yeshi/catkin_ws/src/control/${idir}'.  Ask the maintainer 'aura <aura@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yeshi/catkin_ws/src/control/devel/lib;/opt/ros/groovy/lib)
